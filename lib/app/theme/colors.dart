...
Color colorMarhoom = Color(0xff673AB7);
Color colorThemeFent = Color(0xFF374251).withAlpha(100);
//Color colorThemeFent = new Color(0xff673AB7).withOpacity(0.7);
Color colorText = Color(0xfffffff0);
