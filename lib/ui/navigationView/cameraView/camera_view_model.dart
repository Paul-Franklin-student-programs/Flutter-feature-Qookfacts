...
class CameraViewModel extends ReactiveViewModel with WidgetsBindingObserver {
  double screenWidth;
  double screenHeight;
  ...
  Future<bool> loadModel({
    ...
    final modelFile  = null;
   // final modelFile = await mlService.setupModel();
    if(modelFile != null){
  ...
  void initializeCamera(BuildContext context) async {
    ...
    try {
      ...
      print('camera startup error: '+ e.toString());
  ...
  @override
  List<ReactiveServiceMixin> get reactiveServices => [mlService];
}
