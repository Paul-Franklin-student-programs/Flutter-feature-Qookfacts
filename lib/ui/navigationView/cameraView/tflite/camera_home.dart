...
import 'yolo_camera_view.dart';

/// [CameraHome] stacks [CameraView] and [BoxWidget]s with bottom sheet for stats
class CameraHome extends StatefulWidget {

  static const String id = 'yolo_view';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            // Camera View
            YoloCameraView(resultsCallback, statsCallback),
            // Bounding boxes
