...
class ImageUtils {
  ...
  /// Converts a [CameraImage] in YUV420 format to [imageLib.Image] in RGB format
  static img_lib.Image convertYUV420ToImage(CameraImage cameraImage) {
  ...
  static void saveImage(img_lib.Image image, [int i = 0]) async {
    List<int> jpeg = img_lib.JpegEncoder().encodeImage(image);
