...
//     // TensorBuffer numLocations = TensorBufferFloat(_outputShapes[1]);
//     //
//     // // Inputs object for runForMultipleInputs
//     // // Use [TensorImage.buffer] or [TensorBuffer.buffer] to pass by reference
//     // List<Object> inputs = [inputImage.buffer];
...
//     //     _outputShapes[1][0],
//     //         (_) => new List.generate(_outputShapes[1][1],
//     //             (_) => new List.filled(_outputShapes[1][1], 0.0),
//     //         growable: false),
//     //     growable: false);
//     //
//     // // Inputs object for runForMultipleInputs
...
class Classifier {
  ...
  //     "groceries-yolov4-tiny-rot-416-08-07-22.tflite";
  // static const String MODEL_FILE_NAME =
  //     "groceries-yolov4-tiny-416-07-28-22.tflite";
  static const String LABEL_FILE_NAME = "groceries.txt";
  // static const String MODEL_FILE_NAME = "tinyfood12-1.tflite";
  // static const String LABEL_FILE_NAME = "food2.txt";
    ...
    try {
      ...
      _interpreter = interpreter ??
          await Interpreter.fromFile(
            MlService.localModelPath,
            options: InterpreterOptions()..threads = numThreads, //myOptions,
          );

      debugPrint('FirebaseFilePath-${MlService.localModelPath}');
