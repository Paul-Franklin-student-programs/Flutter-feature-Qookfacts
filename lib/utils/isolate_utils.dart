      ...
      if (isolateData != null) {
       /* Classifier classifier = Classifier(
        ...
        if (Platform.isAndroid) {
          ...
          Pointer<Uint8> p =
              malloc( isolateData.cameraImage.planes[0].bytes.length);
          Pointer<Uint8> p1 =
              malloc( isolateData.cameraImage.planes[1].bytes.length);
          Pointer<Uint8> p2 =
              malloc( isolateData.cameraImage.planes[2].bytes.length);
